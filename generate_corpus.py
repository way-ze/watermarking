## to be uploaded to Euler so that we generate large samples of text.
...
def main(args): 
    ...
    if not args.skip_model_load:
        ...
        with open("corpus_with_watermark_10.json", "w") as file:
            json.dump(corpus_with_watermark, file)

        with open("corpus_without_watermark_10.json", "w") as file:
